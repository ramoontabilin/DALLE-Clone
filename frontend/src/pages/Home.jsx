...
const Home = () => {
	...
	return (
		<section className="max-w-7xl mx-auto">
			<div>
				<h1 className='font-extrabold text-[#222328] text-3xl'>Community Creations</h1>
				<p className='mt-2 text-[#666e75] max-w-[500]'>Browse through a collection of images generated by the community from DALL-E</p>
			</div>
			<div className="mt-16">
				<FormField
					type="text"
			...
			<div className="mt-10">
				{loading ? (
					...
					<>
						{searchText && (
							<h2 className="text-medium text-[#666e75] text-xl mb-3">
